			...
			<form method="post">
				...
				<div class="question-row">
					...
					<div class="form-group row">
						...
						<span class="btn btn-default add-option btn-sm" style="color:gray" data-toggle="tooltip" title="Add new answer"  onclick="addChoice_ide(this)">
						...
						<table width="100%" class="choice-table">
							<tr class="choice  normal-choice">
								...
								<td>
									...
									<input type="text" required="" class="form-control choices_desc" name="choices_desc[0][]" value="" placeholder="Computer and computers with 's' are treated differently. Not case-sensitve">
								</td>
							</tr>
						</table>

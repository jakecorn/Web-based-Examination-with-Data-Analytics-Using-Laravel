                ...
                <div class="panel-body">
                    <form class="form-horizontal" style="padding:0px 15px 0px 15px " method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('degree') ? ' has-error' : '' }}">
                            <label for="degree" class="control-label">Highest Degree <small>Only the acronym. This will be displayed after your name.</small></label>
                        ...
                        <div class="form-group{{ $errors->has('cp_number') ? ' has-error' : '' }}">
                            <label for="password" class="control-label">Cellphone Number</label>
